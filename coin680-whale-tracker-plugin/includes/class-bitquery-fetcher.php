...
class Coin680Bitquery_Fetcher {
    ...
    public static function create_table() {
        ...
        // Back to 5 min as of later on 2026-07-30 (briefly 2 min earlier the
        // same day) -- see the self-healing interval check in
        // coin680whale_init() in the main plugin file for why.
